...
import GroupAtMessage from './group-at-message';
...
export class OpenAPI implements IOpenAPI {
  ...
  public groupAtMessageApi!: GroupAtMessageAPI;
  ...
  public register(client: IOpenAPI) {
    ...
    client.userMessageApi = new UserMessage(this.request, this.config);
    client.groupAtMessageApi = new GroupAtMessage(this.request, this.config);
